                                            ...
                                            <div class="x_content">
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-9 col-sm-9 col-xs-9 tips">
                                                        ...
                                                        <a href="javascript:void(0);" data-toggle="modal" data-target="#helpModal" data-img="${cdn}/assets/admin/images/spider/uid/imooc.png" data-title="慕课网“用户ID”获取方式">慕课网</a> |
                                                        <a href="javascript:void(0);" data-toggle="modal" data-target="#helpModal" data-img="${cdn}/assets/admin/images/spider/uid/csdn.png" data-title="CSDN“用户ID”获取方式">CSDN</a> |
                                                        <a href="javascript:void(0);" data-toggle="modal" data-target="#helpModal" data-img="${cdn}/assets/admin/images/spider/uid/iteye.png" data-title="ITeye“用户ID”获取方式">ITeye</a> |
                                                        <a href="javascript:void(0);" data-toggle="modal" data-target="#helpModal" data-img="${cdn}/assets/admin/images/spider/uid/cnblogs.png" data-title="博客园“用户ID”获取方式">博客园</a>
                                                    </div>
                                                </div>
                                                <div class="item form-group">
                                                ...
                                                <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-3"></label>
                                                    <div class="col-md-9 col-sm-9 col-xs-9 tips">
                                                        <i class="fa fa-exclamation-circle"></i> 需要登录时设置。Cookie获取方式： <a href="javascript:HandlerInterceptor;" data-toggle="modal" data-target="#helpModal" data-img="${cdn}/assets/admin/images/spider/cookie/cookie.png" data-title="“Cookie”获取方式（通用）">以CSDN为例</a>
                                                    </div>
                                                </div>
                                                <div class="item form-group">
