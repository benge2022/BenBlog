...
public class BlogCodegenApplication {
    ...
    public static void main(String[] args) {
        Generator g = new Generator(Config.getInstance()
                ...
                .setUrl("jdbc:mysql://127.0.0.1:3306/ben_blog?serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf-8&autoReconnect=true&zeroDateTimeBehavior=convertToNull&allowMultiQueries=true&useSSL=false&allowPublicKeyRetrieval=true&useLegacyDatetimeCode=false&autoReconnect=true&failOverReadOnly=false")
                .setUsername("root")
                .setPassword("root")
