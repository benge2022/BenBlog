                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="item ${(item_index == 0)?string('active','')}">
                                <a href="${config.siteUrl}/article/${item.id?c}">
                                    <img src="${item.coverImage}" onerror="this.src='${cdn}/assets/web/img/defaultbanner.png'" alt="${item.title}" title="${item.title}">
                                </a>
                    ...
                    <article class="fade-in">
                        <#if item.coverImage?? && (item.coverImage?length > 7)>
                            <figure class="thumbnail">
                                <a href="${config.siteUrl}/article/${item.id?c}">
                                    <img width="150" height="150" <#if config.lazyloadPath!>data-original<#else>src</#if>="${item.coverImage}" onerror="this.src='${cdn}/assets/web/img/default.png'" class="img-responsive lazy-img" alt="${item.title!}">
                                </a>
                            </figure>
                        </#if>
                ...
                <article class="fade-in" style="height: auto">
                    <div class="rows">
                        ...
                        <div class="col-md-2 col-sm-12">
                            <img src="${cdn}/assets/web/img/wrong.gif?${cdnv}" class="center-block" alt="惩罚我" style="width: 110px;margin-top: -10px;">
                        </div>
                    </div>
