                ...
                columns: [
                    {
                        ...
                        formatter: function (code, row, index) {
                            return '<ul class="list-unstyled">' +
                                    '<li>' +
                                    '<a href="' + row.url + '" target="_blank"><img src="' + filterXSS(row.avatar) + '" onerror="this.src=\'${cdn}/assets/admin/images/user.png?${cdnv}\'" style="width: 20px;border-radius: 50%;position: relative;top: -2px;"/> ' + filterXSS(row.nickname) + '</a>' +
