            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="">
                    <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                        <img src="${cdn}/assets/admin/images/loading.gif?${cdnv}" alt=""><#if user??>${user.username!}<#else>管理员</#if>
                        ...
                        <#if getNewCommentInfo['total'] gt 0>
                            <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                                <#list getNewCommentInfo["comments"] as item>
                                    <li>
                                        <a href="/comments">
                                            <span class="image"><img src="${item.avatar}" onerror="this.src='${cdn}/assets/admin/images/user.png?${cdnv}'" alt="user avatar"></span>
                                            <span>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-sm-12 col-md-12" style="text-align: center;margin: 0 auto;float: initial">
                    <a href="${cdn}/assets/admin/images/reward/zfb_code.png?${cdnv}" class="showImage" title="支付宝收钱码" rel="external nofollow">
                        <img src="${cdn}/assets/admin/images/reward/zfb_code.png?${cdnv}" alt="支付宝收钱码" class="img-rounded" style="width: 250px;height: auto;">
                    </a>
                    <a href="${cdn}/assets/admin/images/reward/wx_code.png?${cdnv}" class="showImage" title="微信收钱码" rel="external nofollow">
                        <img src="${cdn}/assets/admin/images/reward/wx_code.png?${cdnv}" alt="微信收钱码" class="img-rounded" style="width: 250px;height: auto">
                    </a>
                </div>
