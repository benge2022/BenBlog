...
<@header>
    <link href="${cdn}/assets/admin/plugin/simplemde/1.11.2/dist/simplemde.min.css?${cdnv}" rel="stylesheet">
    <link href="${cdn}/assets/admin/plugin/github-markdown-css/2.10.0/github-markdown.min.css?${cdnv}" rel="stylesheet">
    <link href="${cdn}/assets/admin/plugin/highlight.js/9.12.0/styles/github.css?${cdnv}" rel="stylesheet">
    <style>
...
<@footer>
    ...
    <script type="text/javascript" src="${cdn}/assets/admin/plugin/highlight.js/9.12.0/lib/highlight.js?${cdnv}"></script>
    <script type="text/javascript" src="${cdn}/assets/admin/plugin/simplemde/1.11.2/dist/simplemde.min.js?${cdnv}"></script>
    <script type="text/javascript" src="${cdn}/assets/admin/js/inline-attachment.js?${cdnv}"></script>
    <script type="text/javascript" src="${cdn}/assets/admin/js/codemirror.inline-attachment.js?${cdnv}"></script>
    <script>
        var op = {
            id: "contentMd",
            uniqueId: "mdEditor_1",
    ...
    <script src="${cdn}/assets/admin/js/zhyd.publish-article.js?${cdnv}"></script>
</@footer>
