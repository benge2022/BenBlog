                            ...
                            <div class="col-md-55">
                                <div class="thumbnail">
                                    <div class="image view view-first">
                                        <img style="display: block;margin: 0 auto;margin-top: 10px;" src="${cdn}/assets/admin/images/loading.gif" alt="image" />
                                    </div>
                                    <div class="caption">
                                        <p>暂无可用的图片... </p>
                                    </div>
                ...
                $.ajax({
                    ...
                    success: function (json) {
                        var tpl = '{{#list}}<div class="col-md-55">\n' +
                            ...
                            '                        </div>\n' +
                            '                        <div class="caption">\n' +
                            '                            <p><span title="{{originalFileName}}">{{originalFileName}}</span><img src="${cdn}/assets/admin/images/icons/{{storageType}}.svg" alt="{{storageType}}" title="{{storageType}}"></p>\n' +
                            '                        </div>\n' +
                            '                    </div>\n' +
                            '                </div>{{/list}}';
