...
<@header title="${article.title} | ${config.siteName}" keywords="${article.keywords!},${config.siteName}" description="${article.description!}"
    ...
    <link rel="stylesheet" href="${cdn}/assets/web/plugin/social-share/1.0.16/dist/css/share.min.css?${cdnv}" />
</@header>
<#if article.coverImage??>
    <img src="${article.coverImage!}" onerror="this.src='${cdn}/assets/web/img/default.png'" style="display: none;" id="cover-img">
</#if>
                        ...
                        <#if hotList?? && (hotList?size > 0)>
                            ...
                            <li class="line-li">
                                <div class="line-container">
                                    <div class="line-left">
                                        <#if item.coverImage??>
                                            <img class="lazy-img" <#if config.lazyloadPath!>data-original<#else>src</#if>="${item.coverImage}" onerror="this.src='${cdn}/assets/web/img/default.png'"width="50" height="50" rel="external nofollow"/>
                                        <#else>
                                            <img class="lazy-img" <#if config.lazyloadPath!>data-original<#else>src</#if>="${cdn}/assets/web/img/favicon.ico" onerror="this.src='${cdn}/assets/web/img/default.png'"width="50" height="50" rel="external nofollow"/>
                                        </#if>
                                    </div>
...
<@footer>
    ...
    <script type="text/javascript" src="${cdn}/assets/web/plugin/highlight.js/9.12.0/lib/highlight.js?${cdnv}"></script>
	<script type="text/javascript" src="${cdn}/assets/web/plugin/simplemde/1.11.2/dist/simplemde.min.js?${cdnv}"></script>
    <script type="text/javascript" src="${cdn}/assets/web/plugin/social-share/1.0.16/dist/js/social-share.min.js?${cdnv}"></script>
<#--    <script type="text/javascript" src="${cdn}/assets/web/plugin/social-share/1.0.16/dist/js/jquery.share.min.js?${cdnv}"></script>-->
