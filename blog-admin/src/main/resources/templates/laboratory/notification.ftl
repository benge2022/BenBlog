                            ...
                            <div class="x_content">
                                <div class="messanger">
                                    <div class="messages">
                                        ...
                                        <#--<div class="message">
                                            <img src="${cdn}/assets/admin/images/user.png?${cdnv}">
                                            <p class="info">Hello there!<br>Good Morning</p>
                                        </div>
                                        <div class="message me">
                                            <img src="${cdn}/assets/admin/images/loading.gif?${cdnv}">
                                            <p class="info">Hi<br>Good Morning</p>
                                        </div>
                                        <div class="message"><img src="${cdn}/assets/admin/images/user.png?${cdnv}">
                                            <p class="info">How are you?</p>
                                        </div>
                                        <div class="message me"><img src="${cdn}/assets/admin/images/loading.gif?${cdnv}">
    ...
    <script type="text/javascript">
        $("#send-btn").click(function () {
            ...
            $.post("/api/notice", {msg : msg}, function (json) {
                if (json.status == 200) {
                    $messages.append('<div class="message me"><img src="${cdn}/assets/admin/images/loading.gif?${cdnv}"><p class="info">' + msg + '</p></div>');
                } else {
                    if (json.message) {
