                            ...
                            <li>
                                <blockquote>
                                    <ul class="list-unstyled">
                                        ...
                                        <li>复制添加本站图标：<strong>/assets/web/img/favicon.ico</strong></li>
                                    </ul>
                                </blockquote>
                            </li>
                        ...
                        <table class="table table-hover table-condensed table-bordered">
                            ...
                            <#if link.disableList>
                                <#list link.disableList as item>
                                    <tr>
                                        <td><img src="${item.favicon}" alt="${item.name}" onerror="this.src='${cdn}/assets/web/img/user.png'" style="width: 20px;" rel="external nofollow"></td>
                                        <td>${item.name}</td>
                                        <td>${item.remark}</td>
                        ...
                        <#list link.indexList as item>
                            <li>
                                <a href="${item.url}" target="_blank" title="${item.description}" data-toggle="tooltip" data-placement="bottom">
                                    <img src="${item.favicon}" alt="${item.name}" onerror="this.src='${cdn}/assets/web/img/user.png'">${item.name}
                                </a>
                            </li>
                        </#list>
                        </ul>
