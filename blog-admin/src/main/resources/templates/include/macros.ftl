...
<head>
    ...
    <link href="${cdn}/assets/admin/images/favicon.ico?${cdnv}" rel="shortcut icon" type="image/x-icon">
    <#if config.adminCssCdn?? && (config.adminCssCdn?length > 0)>
        ${config.adminCssCdn!}
    <#else >
        <link href="${cdn}/assets/admin/plugin/font-awesome/4.7.0/css/font-awesome.min.css?${cdnv}" rel="stylesheet" type="text/css">
        <link href="${cdn}/assets/admin/plugin/twitter-bootstrap/3.3.5/css/bootstrap.min.css?${cdnv}" rel="stylesheet">
        <link href="${cdn}/assets/admin/plugin/jquery-confirm/3.3.2/jquery-confirm.min.css?${cdnv}" rel="stylesheet">
        <link href="${cdn}/assets/admin/plugin/fancybox/2.1.5/jquery.fancybox.min.css?${cdnv}" rel="stylesheet">
        <link href="${cdn}/assets/admin/plugin/nprogress/0.2.0/nprogress.min.css?${cdnv}" rel="stylesheet">
        <link href="${cdn}/assets/admin/plugin/toastr.js/2.0.3/css/toastr.min.css?${cdnv}" rel="stylesheet">
        <link href="${cdn}/assets/admin/plugin/iCheck/1.0.2/skins/square/green.css?${cdnv}" rel="stylesheet">
        <link href="${cdn}/assets/admin/plugin/bootstrap-table/1.11.1/dist/bootstrap-table.min.css?${cdnv}" rel="stylesheet">
        <link href="${cdn}/assets/admin/plugin/bootstrap-daterangepicker/2.1.25/daterangepicker.css?${cdnv}" rel="stylesheet">
        <link href="${cdn}/assets/admin/plugin/bootstrap-datetimepicker/4.17.49/build/css/bootstrap-datetimepicker.min.css?${cdnv}" rel="stylesheet">
        <link href="${cdn}/assets/admin/plugin/zTree.v3/3.5.37/css/metroStyle/metroStyle.css?${cdnv}" rel="stylesheet">
        <link href="${cdn}/assets/admin/plugin/switchery/0.8.2/switchery.min.css?${cdnv}" rel="stylesheet">
        <link href="${cdn}/assets/admin/plugin/bootstrap-tagsinput/0.8.0/bootstrap-tagsinput-typeahead.css?${cdnv}" rel="stylesheet">
        <link href="${cdn}/assets/admin/plugin/bootstrap-tagsinput/0.8.0/bootstrap-tagsinput.css?${cdnv}" rel="stylesheet">
    </#if>
    <link href="${cdn}/assets/admin/css/bootstrap-treetable.css?${cdnv}" rel="stylesheet" type="text/css" />
    <link href="${cdn}/assets/admin/css/zhyd.core.css?${cdnv}" rel="stylesheet">
    <#nested>
</head>
<body class="nav-md">
            ...
            <div class="left_col scroll-view">
                ...
                <div class="profile clearfix">
                    <div class="profile_pic">
                        <img src="${cdn}/assets/admin/images/loading.gif?${cdnv}" alt="..." class="img-circle profile_img">
                    </div>
            ...
            <div class="modal-body notice-box">
                <div class="row">
                    <div class="col col-lg-4 col-sm-4 col-md-4 col-xs-4">
                        <fieldset>
                            <legend>关注公众号</legend>
                            <a href="${cdn}/assets/admin/images/wechat_account_500x500.jpg?${cdnv}" class="showImage" title="关注公众号：码一码" rel="external nofollow" style="display: block;text-align: center">
                                <img src="${cdn}/assets/admin/images/wechat_account_500x500.jpg?${cdnv}" class="img-rounded" alt="关注公众号：码一码" width="300">
                            </a>
                        </fieldset>
                    </div>
                    <div class="col col-lg-4 col-sm-4 col-md-4 col-xs-4">
