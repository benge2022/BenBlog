...
<head>
    ...
    <#if hasEditor>
        <link href="${cdn}/assets/web/plugin/simplemde/1.11.2/dist/simplemde.min.css?${cdnv}" rel="stylesheet">
        <link href="${cdn}/assets/web/plugin/github-markdown-css/2.10.0/github-markdown.min.css?${cdnv}" rel="stylesheet">
        <link href="${cdn}/assets/web/plugin/highlight.js/9.12.0/styles/github.css?${cdnv}" rel="stylesheet">
    </#if>
    <#nested>
        ...
        <div class="col-sm-12 col-md-12" style="float: initial;">
            <#if config.zfbPraiseCode!>
                <a href="${config.zfbPraiseCode}" class="showImage" title="支付宝收钱码" rel="external nofollow">
                    <img src="${config.zfbPraiseCode}" onerror="this.src='${cdn}/assets/web/img/default.png'" alt="支付宝收钱码" class="img-rounded" style="width: 250px;height: auto;">
                </a>
            </#if>
            <#if config.wxPraiseCode!>
                <a href="${config.wxPraiseCode}" class="showImage" title="微信收钱码" rel="external nofollow">
                    <img src="${config.wxPraiseCode}" onerror="this.src='${cdn}/assets/web/img/default.png'" alt="微信收钱码" class="img-rounded" style="width: 250px;height: auto;">
                </a>
            </#if>
        </div>
    </#if>
