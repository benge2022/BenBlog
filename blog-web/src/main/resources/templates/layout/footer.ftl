...
<#if config.webJsCdn?? && (config.webJsCdn?length > 0)>
    ${config.webJsCdn!}
<#else >
    <script type="text/javascript" src="${cdn}/assets/web/plugin/jquery/1.11.1/jquery.min.js?${cdnv}"></script>
    <script type="text/javascript" src="${cdn}/assets/web/plugin/twitter-bootstrap/3.3.5/js/bootstrap.min.js?${cdnv}"></script>
    <script type="text/javascript" src="${cdn}/assets/web/plugin/jquery.lazyload/1.9.1/jquery.lazyload.min.js?${cdnv}"></script>
    <script type="text/javascript" src="${cdn}/assets/web/plugin/jquery-confirm/3.3.2/jquery-confirm.min.js?${cdnv}"></script>
    <script type="text/javascript" src="${cdn}/assets/web/plugin/fancybox/2.1.5/jquery.fancybox.min.js?${cdnv}"></script>
    <script type="text/javascript" src="${cdn}/assets/web/plugin/bootstrap-validator/0.5.3/dist/js/bootstrapValidator.min.js?${cdnv}"></script>
    <script type="text/javascript" src="${cdn}/assets/web/plugin/nprogress/0.2.0/nprogress.min.js?${cdnv}"></script>
    <script type="text/javascript" src="${cdn}/assets/web/plugin/js-xss/0.3.3/xss.min.js?${cdnv}"></script>
    <script type="text/javascript" src="${cdn}/assets/web/plugin/mustache.js/2.3.0/mustache.min.js?${cdnv}"></script>
</#if>
<script type="text/javascript">
    var appConfig = {
        ...
        staticPath: "${cdn}/assets/web",
        lazyloadPath: "${config.lazyloadPath}",
        fileStoragePath: "${config.fileStoragePath}",
        wxPraiseCode: "${config.wxPraiseCode}" || "${cdn}/assets/web/img/default.png",
        zfbPraiseCode: "${config.zfbPraiseCode}" || "${cdn}/assets/web/img/default.png",
...
<script type="text/javascript" src="${cdn}/assets/web/js/zhyd.core.js?${cdnv}"></script>
<script type="text/javascript" src="${cdn}/assets/web/js/zhyd.comment.js?${cdnv}"></script>
<script type="text/javascript" src="${cdn}/assets/web/js/zhyd.js?${cdnv}"></script>
